...
@Component({
  selector: 'app-property-terms-condition',
   standalone: true,
  imports: [CommonModule,FormsModule],
  templateUrl: './property-terms-condition.html',
  styleUrl: './property-terms-condition.css',
})
export class PropertyTermsCondition {

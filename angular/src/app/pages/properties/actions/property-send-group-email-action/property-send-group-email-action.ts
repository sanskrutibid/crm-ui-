...
@Component({
  selector: 'app-property-send-group-email-action',
  imports: [CommonModule, FormsModule, QuillModule],
  templateUrl: './property-send-group-email-action.html',
  styleUrl: './property-send-group-email-action.css',
})
export class PropertySendGroupEmailAction implements OnInit {

...
@Component({
  selector: 'app-property-send-sms',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './property-send-sms.html',
  styleUrl: './property-send-sms.css',
})
export class PropertySendSms implements OnInit {
  ...
  scheduleSMS() {
    ...
    this.opportunitiesService.sendSms(this.propertyId, payload).subscribe({
      next: () => {

...
@Component({
  selector: 'app-opportunity-site-visits',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './opportunity-site-visits.html',
  styleUrl: './opportunity-site-visits.css',
})
export class OpportunitySiteVisits implements OnInit {
  @Input() lead: any;
  ...
  loadSiteVisits() {
    const targetLeadId = this.lead?.id || this.lead?._id;
    const targetContactId = this.lead?.contactId?._id || this.lead?.contactId?.id || this.lead?.contactId;
